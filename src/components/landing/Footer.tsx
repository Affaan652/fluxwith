...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t border-line/50 bg-void-deep">
      {/* Newsletter section */}
          ...
          >
            <div className="max-w-md text-center lg:text-left">
              ...
              <p className="text-fume text-sm">
                Get updates on new features, tips, and exclusive offers. No spam, unsubscribe anytime.
              </p>
            </div>
            ...
            <form className="flex w-full max-w-md gap-3" onSubmit={(e) => e.preventDefault()}>
              <input
                ...
                className="flex-1 rounded-xl bg-ash border border-line px-5 py-3 text-sm text-bone placeholder:text-fume focus:outline-none focus:border-flux-cyan focus:ring-1 focus:ring-flux-cyan transition-colors"
              />
              <button
                type="submit"
      ...
      <div className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-6">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-sm text-fume leading-relaxed max-w-xs mb-6">
              AI-powered website generation platform. Transform your ideas into beautiful, 
              functional websites in minutes — no coding required.
            </p>
            ...
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-lg bg-ash border border-line flex items-center justify-center text-fume hover:text-flux-cyan hover:border-flux-cyan/50 hover:bg-flux-cyan/10 transition-all"
      ...
      <div className="border-t border-line/30">
        <div className="mx-auto max-w-7xl px-6 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-fume">
            © {currentYear} FluxWith. All rights reserved.
          </p>
          
          <div className="flex items-center gap-6 text-sm text-fume">
