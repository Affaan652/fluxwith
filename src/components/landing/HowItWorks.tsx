    ...
    <section className="bg-white/[0.02] py-16">
      <div className="mx-auto max-w-6xl px-6">
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className="relative inline-flex items-center justify-center mb-4">
                <span className="absolute -top-1 -right-1 flex h-5 w-5 items-center justify-center rounded bg-white text-[10px] font-bold text-black">
                  {step.number}
                </span>
                <div className="rounded-lg bg-black p-4 border border-white/10 text-gray-300 shadow-lg">
                  {step.icon}
                </div>
              </div>
        ...
        <motion.div
          ...
          className="mt-10 rounded-lg border border-white/10 bg-black p-6"
        >
          <div className="grid md:grid-cols-3 gap-6 items-center">
            <div className="space-y-3">
              <div className="flex items-start gap-2">
                ...
                <div>
                  <p className="font-medium text-sm text-white">Natural language input</p>
                  <p className="text-xs text-gray-500">Just describe what you want</p>
                </div>
              </div>
              <div className="flex items-start gap-2">
                <div className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-blue-500" />
                <div>
                  <p className="font-medium text-sm text-white">Smart AI processing</p>
                  <p className="text-xs text-gray-500">Context-aware building</p>
                </div>
              </div>
              <div className="flex items-start gap-2">
                <div className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-violet-500" />
                <div>
                  <p className="font-medium text-sm text-white">Instant preview</p>
                  <p className="text-xs text-gray-500">See results in real-time</p>
                </div>
              </div>
            </div>

            <div className="md:col-span-2 rounded-lg bg-white/[0.03] p-5 border border-white/5">
              <div className="flex items-center gap-2 mb-3">
                <div className="h-2 w-2 rounded-full bg-red-400" />
                <div className="h-2 w-2 rounded-full bg-yellow-400" />
                <div className="h-2 w-2 rounded-full bg-green-400" />
                <div className="ml-3 flex-1 h-4 rounded bg-white/5 border border-white/10" />
              </div>
