...
export default function Terms() {
  return (
    <LegalLayout title="Terms of Service" lastUpdated="[Insert launch date]">
      ...
      <section>
        <h2 className="font-display text-lg font-medium text-bone">2. AI-generated output disclaimer</h2>
        <p className="mt-2 text-fume">
          Site layouts, copy, and code produced by the Service are generated by an AI model and
          may contain errors, inaccuracies, or unexpected behavior. The Service does not warrant
          that generated output is complete, correct, or fit for any particular purpose. Review
          and test generated content before relying on it or publishing it live.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="mt-2 text-fume">
          ...
          attempts to exploit or circumvent API or generation limits, or any activity that
