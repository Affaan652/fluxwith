    ...
    <section className="relative bg-void py-20 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-6xl px-6">
        ...
        >
          ...
          <p className="mt-4 text-sm leading-relaxed text-fume">
          ...
          {/* Social proof */}
          <div className="mt-12 flex flex-wrap items-center justify-center gap-x-8 gap-y-3 text-xs text-fume">
            <div className="flex items-center gap-1.5">
              <svg className="h-4 w-4 text-flux-cyan" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z" />
              </svg>
              <span>SSL Security</span>
            </div>
            <div className="flex items-center gap-1.5">
              <svg className="h-4 w-4 text-flux-amber" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
