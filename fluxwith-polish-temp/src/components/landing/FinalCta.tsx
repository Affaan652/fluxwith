      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        >
          ...
          <div className="mt-8 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
            <Link
              to="/signup"
              className="inline-flex items-center gap-2 rounded-lg bg-white px-7 py-3 text-sm font-semibold text-black transition-all hover:bg-gray-100 active:scale-[0.96] duration-150 ease-out"
            >
              Get started free
            ...
            <Link
              to="/showcase"
              className="inline-flex items-center gap-2 rounded-lg border border-white/20 px-7 py-3 text-sm font-semibold text-white transition-all hover:border-white/30 hover:bg-white/5 active:scale-[0.96] duration-150 ease-out"
            >
              View examples
            </Link>
          </div>
